...
export default function ScheduleEditor() {
  ...
  return (
    <div data-schedule-editor-overlay className="fixed inset-0 z-50 flex items-center justify-center bg-black/20 backdrop-blur-[1px] animate-in fade-in duration-150">
      <div data-schedule-editor className="bg-white rounded-2xl shadow-xl w-[480px] max-h-[85vh] flex flex-col">
        {/* Header */}
